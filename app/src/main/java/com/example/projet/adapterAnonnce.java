...
public class adapterAnonnce extends FirebaseRecyclerAdapter<annonce,adapterAnonnce.myViewHolder> {
     ...
     * @param options
     */
    public adapterAnonnce(@NonNull FirebaseRecyclerOptions<annonce> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder,final int position, @NonNull annonce model) {
